...
namespace PostmarkEmailService.Converters
{
    internal class PostmarkConverter : ISerializer, IDeserializer
    {
        private readonly JsonSerializer _serializer;

        public PostmarkConverter(JsonSerializerSettings settings)
        {
