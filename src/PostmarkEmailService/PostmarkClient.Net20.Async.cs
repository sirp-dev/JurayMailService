...
using PostmarkEmailService.Model;
...
namespace PostmarkEmailService
{
    public partial class PostmarkClient
    {
        ...
        public IAsyncResult BeginSendMessage(string from, string to, string subject, string textBody, string htmlBody)
        {
            return BeginSendMessage(from, to, subject, textBody, htmlBody, null);
        }
        ...
        {
            return BeginSendMessages(messages ?? new PostmarkMessage[0] );
        }
