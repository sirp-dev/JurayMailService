...
using PostmarkEmailService.Model.Webhooks;
...
namespace PostmarkEmailService
{
    ...
    /// </summary>
    /// <remarks>
    /// Make sure to include "using PostmarkEmailService;" in your class file, which will include extension methods on the base client.
    /// </remarks>
