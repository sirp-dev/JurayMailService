...
namespace PostmarkEmailService
{
    ...
    public partial interface IPostmarkClient
    {
        ...
        PostmarkResponse SendMessage(string from, string to, string subject, string textBody, string htmlBody);
        ...
        /// <returns>A <see cref = "PostmarkResponse" /> with details about the transaction.</returns>
        PostmarkResponse SendMessage(string from, string to, string subject, string textBody, string htmlBody, HeaderCollection headers);
